...
const DoctorDashboard = (props) => {
  ...
  return (
    <div className="full-body col-span-10 h-screen bg-lime-200">
      <div className="body-without-footer">
        <div className="main m-2  ">

          <div className="">
            <div className="flex  h-12 m-2 bg-lime-200 rounded mt-4 ">
              <div>
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4  ml-80 h-14 ">
                  <img
                    src={doctor_profile}
                  ...
                  <div className="grid grid-rows-2 ml-4 gap-2  mb-4">
                    <div className="font-bold font-lato text-base">
                      <h1 className="">
          ...
          <form
            ...
            className="grid grid-cols-9 bg-white rounded p-4 ml-12 mr-8 mt-4 shadow-2xl"
          >
            <div className="grid col-start-1 col-span-3">
              <h1 className="text-xl font-lato font-bold p-2 ">
            ...
            <div className=" grid col-span-3">
              <input
                ...
                className="bg-gray-100 rounded border-2 text-xl   pl-4  focus:outline-none"
                type="number"
            ...
            {Loading ? (
              ...
              <div className=" grid col-start-8  h-10 ml-4  bg-cyan-300  rounded font-semibold font-lato shadow-2xl hover:bg-gray-100  ">
                <div className="flex py-2 px-4 items-center ">
                  <img src={search} className=" h-4  " alt="search"></img>
                  <button className="ml-2 flex  rounded font-semibold font-lato shadow-sm hover:bg-gray-100   ">
                    Search
                  </button>
                </div>
              </div>
            )}
            <div className="grid col-start-9  h-10 ml-4  bg-cyan-300  rounded font-semibold font-lato shadow-sm hover:bg-gray-100  ">
              <div className="flex py-2 px-4 items-center ">
                <div
                  className="ml-2 flex cursor-pointer rounded font-semibold font-lato shadow-sm hover:bg-gray-100 "
                  onClick={() => {
                    props.setHealthID("");
                  }}
                >
          ...
          {Object.keys(patient).length !== 0 ? (
            <div className="grid grid-cols-2">
              <div className="m-4 p-4">
                <div>
                  <h1 className="font-bold font-lato text-xl ">
                    Patient Details
                  </h1>
                </div>
                <div className="bg-white font-lato p-4 mt-4 px-8 rounded-xl shadow-2xl">
                  <div className="flex">
                    <div>
                      <h1>Name : </h1>
                    </div>
              ...
              <div className="m-4 p-4 ">
                ...
                {prescriptions.length > 0 ? (
                  <div className="bg-white mt-4 font-lato p-4 rounded-xl shadow-2xl px-8">
                    <div className="flex ">
                      <div>
                    ...
                    >
                      <div className=" mt-2 flex items-center justify-evenly text-base bg-cyna-300 py-1 px-2 rounded font-semibold font-lato shadow-sm hover:bg-gray-100 w-5/12  ">
                  ...
                  <div className="bg-gray-100 mt-4 font-lato p-4 rounded-xl shadow px-8 flex justify-center font-bold">
                    {" "}
                    No Data Found...{" "}
                  </div>
                )}
            ...
            <div className="text-xl font-lato flex justify-center items-center font-bold my-60">
              Search Patient to Add Diagnosis
            </div>
          )}

          {Object.keys(patient).length !== 0 ? (
            <div className="font-lato m-4  ">
              <div className="flex justify-between m-8">
                <div className="font-bold text-xl ml-4">
                  <h1>Patient Dashboard</h1>
                </div>
                <Link to="/doctor/addDiagno">
                  <div className=" flex  bg-cyan-300 pl-0 pr-3 py-1 items-center justify-items-center  rounded font-semibold font-lato shadow-sm hover:bg-gray-100   ">
                    <img
                      src={add_pre_logo}
                      className="h-3 mx-3"
                      alt="adddiagno"
              ...
              <div className="bg-white m-4 rounded-lg ">
                <div className="grid grid-rows-2 p-6 gap-2 shadow-2xl">
                    ...
                    prescriptions.slice(1, 3).map((prescription) => {
                      return (
                        <div className="grid grid-cols-4">
                          ...
                          >
                            <div className=" flex  justify-center bg-green-400 py-1 px-3 rounded font-semibold font-lato shadow-sm hover:bg-gray-100 w-2/5   ">
                              <img
                                src={eye}
