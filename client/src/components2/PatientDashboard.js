...
const PatientDashboard = (props) => {
  ...
  return (
    <div className="full-body col-span-10 h-screen font-lato bg-lime-200">
      <div className="body-without-footer max-h-min">
        <div className=" main ">
          <div className="">
            <div className="flex  h-12 m-2 bg-lime-200 rounded mt-4  ">
              <div>
                <h1 className="text-2xl font-lato p-2 ">
                  DashBoard Today
                </h1>
              </div>

              <div className="flex ml-20 shadow-xl h-10 font-lato  ">
                <input
                  placeholder="Search"
              ...
              <Link to="/patient/profile">
                <button className="flex bg-white rounded shadow-xl  px-4  ml-60 h-12 ">
                  <img
                    src={patient_profile}
                    className="h-12 p-2 rounded-2xl"
                    alt="profile"
                  ></img>
                  <div className="mt-3 ml-4  font-bold font-lato">
          ...
          <div className="grid grid-cols-2">
            <div className="m-4 p-4">
              ...
              <div className="bg-white font-lato p-4 mt-4 px-8 rounded-xl shadow-xl">
                <div className="flex">
                  <div>
                    <h1>Name : </h1>
                  </div>
            ...
            <div className="m-4 p-4 ">
              ...
              {prescriptions.length > 0 ? (
                <div className="bg-white mt-4 font-lato p-4 rounded-xl shadow-xl px-8">
                  <div className="flex ">
                    <div>
                  ...
                  >
                    <div className=" mt-2 flex items-center justify-evenly text-base bg-cyan-300 py-1 px-2 rounded font-semibold font-lato shadow-sm hover:bg-gray-100 w-5/12  ">
                ...
                <div className="bg-white mt-4 font-lato p-4 rounded-xl shadow-xl px-8 flex justify-center font-bold">
                  {" "}
                  No Data Found...{" "}
                </div>
              )}
          ...
          <div className="font-lato m-4  ">
            ...
            <div className="bg-white m-4 rounded-lg ">
              <div className="grid grid-rows-2 p-6 gap-2 shadow-xl">
                  ...
                  prescriptions.slice(1, 3).map((prescription) => {
                    return (
                      <div className="grid grid-cols-4">
                        ...
                        >
                          <div className=" flex  justify-center bg-cyan-300 py-1 px-3 rounded font-semibold font-lato shadow-sm hover:bg-gray-100 w-2/5   ">
                            <img
                              src={eye}
