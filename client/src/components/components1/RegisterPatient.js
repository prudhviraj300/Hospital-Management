      ...
      <div className="bg-lime-200 w-full">
        <div className="">
          <div className=" flex justify-center mt-0">
            <h1 className="mt-2 px-8 rounded font-bold text-5xl">Register</h1>
          </div>
          ...
          >
            <div className="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
              <button
                ...
                className={
                  Toggle === "Patient"
                    ? "py-2 px-8 text-lg font-lato font-semibold cursor-pointer rounded bg-cyan-300"
                    : "py-2 px-8 text-lg font-lato font-semibold cursor-pointer rounded bg-gray-200"
                }
              >
                Patient
              </button>
            ...
            >
              <h1 className="font-bold  rounded flex justify-center mt-6">
                 To Register as a doctor contact admin with your complete Details
              </h1>
              <div className="border-4 border-black p-4 mx-auto w-1/2 rounded-xl mt-8  ">
                <h1>Send your complete details</h1>
                <div>
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-4 mr-4">
                ...
                <input
                  ...
                  required
                  className="pl-4 bg-gray-200 lg:h-10  rounded h-8"
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4">
                ...
                <input
                  ...
                  required
                  className="bg-gray-200 lg:h-10 rounded pl-4 col-span-2 h-8"
                  value={patient.email}
                  onChange={(e) => {
                    let temppatient = { ...patient };
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4">
                ...
                <div className="">
                  <select
                    className="pl-4 lg:w-1/2 bg-gray-200 lg:h-10  rounded  h-8"
                    id="blood-group"
              ...
              <div className="lg:grid lg:grid-cols-4 gap-2 mt-4 mr-4 flex">
                ...
                <input
                  type="password"
                  id="password"
                  className="bg-gray-200 lg:h-10  rounded lg:pl-4 h-8 pl-2"
                  required
                ...
                <div className="col-span-4">
                  {diseaseList.map((disease, index) => {
                    return (
                      ...
                      >
                        <input
                          className="bg-gray-200 lg:h-10 col-span-3 rounded lg:pl-4 h-8 pl-2"
                          type="text"
                          name="disease"
                        ...
                        />
                        <input
                          className="bg-gray-200 lg:h-10 col-span-3  rounded lg:pl-4 h-8 pl-2 ml-4"
                          type="text"
                          name="yrs"
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-8 mr-4 flex">
                ...
                <input
                  className="bg-gray-200 rounded h-10 pl-4"
                  placeholder="first name"
              ...
              <div className="mt-4">
                ...
                <input
                  className="bg-gray-200 lg:h-10 ml-24 rounded pl-4 h-8 lg:mt-0 lg:ml-0 mt-2 "
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
                ...
                <div className="grid grid-cols-2 gap-8 col-span-3 ">
                  <input
                    type="text"
                    className="bg-gray-200 h-10  rounded pl-4 "
                    required
                    placeholder="building/area"
              ...
              <div className="flex justify-center mb-4 mt-8">
                {Loading ? (
                  ...
                  <button className="bg-cyan-300 rounded p-2 px-8 font-bold text-xl hover:bg-gray-200 mb-4 ">
                    Submit
                  </button>
                )}
              </div>
