      ...
      <div class="bg-lime-200">
        <div class="">
          <div class=" flex justify-center mt-0">
            <h1 class=" font-lato p-2 px-8 rounded font-bold text-5xl">Register</h1>
          </div>

          <form
            onSubmit={handleRegisterDoctor}
            class="font-lato ml-20 mt-8 px-8 py-4  border-4 border-black bg-white shadow-4xl rounded max-w-screen-lg  mb-4 "
          >
            <div class="flex   mt-2 bg-cyan-200 w-fit  justify-between rounded mx-auto">
              <h1
                className={
                  "py-2 px-8 text-lg font-lato font-semibold cursor-text rounded bg-cyan-300"
                }
              >
                Doctor
              </h1>
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-bold text-base font-lato px-4 my-4 ">
                Doctor Name
              </label>
              <input
                class="bg-gray-100 rounded h-10 pl-4 mt-4"
                required
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              ...
              <input
                type="date"
                class=" bg-gray-100 h-10 rounded pl-4"
                required
                value={doctor.dob}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              ...
              <input
                ...
                required
                class="pl-4 bg-gray-100 h-10  rounded"
                value={doctor.mobile}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              ...
              <input
                ...
                required
                class="bg-gray-100 h-10 rounded pl-4 col-span-2 "
                value={doctor.email}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              ...
              <div className="">
                <select
                  className="pl-4 w-1/2 bg-gray-100 h-10  rounded "
                  id="blood-group"
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
              ...
              <div className="grid grid-cols-2 gap-4 col-span-3 ">
                ...
                <input
                  type="number"
                  className="bg-gray-100 h-10  rounded  pl-4"
                  required
              ...
              <div className=" ">
                {EducationList.map((Education, index) => (
                  <div className=" flex " key={index} id="degree">
                    <input
                      class="bg-gray-100 h-10  rounded mb-8 pl-4 grid col-start-2 col-span-1  "
                      placeholder="eg. MBBS"
                      id="degree"
                      name="degree"
                    ...
                    <div className="flex  ml-4">
                      {index === 0 ? (
                        <div
                          className=" m-2 h-10 w-16 mt-0 ml-4  font-lato font-semibold cursor-pointer "
                      ...
                      <div
                        className=" m-2 h-10 w-20 mt-0   font-lato font-semibold cursor-pointer "
                        onClick={() => {
              ...
              <div className=" ">
                {SpecialityList.map((Special, index) => (
                  <div className=" flex " key={index} id="speciality">
                    <input
                      className="bg-gray-100 h-10  rounded mb-8 pl-4 grid col-start-3 col-span-1"
            ...
            <div class="flex justify-center mb-4 mt-8">
              {Loading ? (
                ...
                <button className="bg-cyan-300 rounded p-2 px-8 font-bold text-xl hover:bg-orange-400 mb-4 ">
                  Submit
                </button>
              )}
            </div>
