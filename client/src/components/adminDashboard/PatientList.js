...
const PatientList = (props) => {
  ...
  return (
    <div className="font-lato col-span-10 bg-lime-200">
      <div>
        <h1 className="font-bold text-xl ml-16 mt-16">Patients List</h1>
      </div>
      <div className="grid grid-rows-2 mt-8 m-14 mr-12  bg-white rounded shadow-2xl p-6 gap-4">
        ...
        {patientList.length > 0 ? (
          ...
          <div className="flex justify-center items-center">
            No Patients are Found on Database
          </div>
        )}
      </div>
    </div>
