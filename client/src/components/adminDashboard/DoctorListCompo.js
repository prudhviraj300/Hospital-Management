  ...
  return (
    <div className="grid grid-cols-9">
      ...
      <button
        ...
        className="flex items-center bg-cyan-300 w-24 h-8 rounded font-bold shadow hover:bg-gray-200"
        onClick={deleteDoctor}
      >
        <img src={delete_btn} alt="delete" className="h-4 mx-2"></img>Delete
      </button>
    </div>
  );
};
