...
const PreviewPrescription = (props) => {
  ...
  return (
    <div
      className="body h-screen col-span-10 font-lato bg-lime-200 overflow-y-scroll scroll-m-0"
      id="prescription"
    >
      <div className="w-3/4  ml-32 bg-white shadow-2xl p-8 mb-4 mt-6">
        ...
        <div className="grid grid-rows-2 mt-4 ">
          <div className="grid grid-cols-2 justify-center border-t-2 border-b-2 border-black ">
            <h1 className="ml-2 font-bold">Major complaints</h1>
            <h1 className="ml-2 font-bold">clinincal findings</h1>
          </div>

          {prescription.chiefComplaints.map((complaint) => {
            return (
              <div className="grid grid-cols-2 justify-center ml-2 border-b-2 border-gray-100">
        ...
        <div className="mt-4">
          <h1 className="font-bold">Investigations</h1>
          <div>
