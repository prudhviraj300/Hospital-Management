...
const PatientHistoryCompoDoctorView = (props) => {
  ...
  return (
    <div className="grid grid-cols-4">
      ...
      >
        <div className=" flex  justify-center bg-cyan-300 py-1 px-3 rounded font-semibold font-lato shadow-sm hover:bg-gray-100 w-2/4   ">
          <img src={eye} alt="view"className="h-4 my-auto"></img>
