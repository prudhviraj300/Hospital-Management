...
const AddNewDiagnosis = (props) => {
  ...
  return (
    <div className="font-lato col-span-10 overflow-y-scroll">
      <div className=" lg:min-h-screen lg:grid grid-cols-6  ">
        <div className=" col-start-1 col-span-6 ml-8">
          ...
          <form
            className="bg-lime-200 shadow-2xl p-6 m-2 ml-2 mt-8 lg:font-bold  "
            onSubmit={handleAddPrescription}
          >
            <div className="mt-3">
              {chiefComplaints.map((chiefComplaint, index) => (
                <div className="grid grid-cols-6 mt-2">
                  <h1 className="col-span-1">MajorComplaints </h1>
                  ...
                  <input
                    ...
                    className=" bg-gray-100  rounded mx-2 px-2 py-1.5 outline-none col-span-1"
                  ></input>
                  <input
                  ...
                  <div className="flex ml-3">
                    <div
                      className=" m-2 h-8 w-16 mt-0  font-lato font-semibold cursor-pointer "
                    ...
                    {chiefComplaints.length > 1 && (
                      <div
                        className=" m-2 h-8 w-20 mt-0 font-lato font-semibold cursor-pointer "
                        onClick={() => {
                          let tempChiefComplaint = [...chiefComplaints];
            ...
            <div className="grid grid-cols-6 mt-3  ">
              ...
              <input
                placeholder=" Note "
                className=" bg-gray-100 rounded mx-2 px-2 py-1.5 outline-none col-span-2"
              ...
              {MedicineList.map((medicine, index) => (
                <div>
                  <div className="grid grid-cols-8">
                    <div className="col-span-3">
                      <div className="grid grid-cols-6 mt-2  ">
                        ...
                        <input
                          ...
                          required
                          className=" bg-gray-100 rounded mx-2 px-2 py-1.5 outline-none col-span-4 ml-14"
                      ...
                      <div className="grid grid-cols-6 mt-3  ">
                        ...
                        <input
                          ...
                          className=" bg-gray-100 rounded mx-2 px-2 py-1.5 outline-none ml-14 col-span-4"
                          value={medicine.type}
                          onChange={(e) => {
                            let tempmedicinelist = [...MedicineList];
                    ...
                    <div className="flex">
                      <div
                        className=" m-2 h-10 w-16 mt-0  font-lato font-semibold cursor-pointer "
            ...
            <div className="flex justify-center mt-8">
              {Loading ? (
                ...
                <button className="bg-green-400 rounded p-2 px-8 font-bold text-xl hover:bg-gray-100 mb-4 ">
                  Submit
                </button>
              )}
            </div>
