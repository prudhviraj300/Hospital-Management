  ...
  return (
    <div className="col-span-10">
      {props.healthID.length === 12 ? (
          ...
          <div className="h-screen">
            <div className="font-lato   mainf">
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  ml-auto h-14 w-1/5 mr-8 mt-8">
                  <img
                    src={doctor_profile}
        ...
        <div className="text-xl font-lato flex justify-center items-center font-bold my-80 py-4 flex-col ">
          <div>Search Patient ID to see Reports</div>
          <Link
            to="/doctor/dashboard"
            className="text-md  font-lato py-1 px-4 bg-cyan-300 rounded mt-3 hover:bg-gray-100"
          >
            Return to DashBoard
          </Link>
        </div>
