...
const DoctorProfile = (props) => {
  ...
  return (
    <body className="font-lato col-span-10 overflow-y-scroll font-lato bg-lime-200">
      <div className="grid grid-cols-2 mt-16">
        <div className="p-4 m-8 bg-white shadow-2xl shadow-opacity-25 w-2/3 mx-auto rounded-md ">
        ...
        <div className="my-2">
          <div className="p-8 m-2 bg-white shadow-2xl w-2/3 rounded-md">
            ...
            <div className="flex mt-4">
              <img src={degree} alt="home" className="h-6 w-6" />
              <h1 className="ml-4">
            ...
            <div className="flex mt-4">
              <img src={speciality} alt="speciality" className="h-6 w-6" />
              <h1 className="ml-4">
          ...
          <div className="p-8 m-2 bg-white shadow-2xl w-2/3 rounded-md mt-10">
            <h1 className="font-bold flex justify-center text-xl">
              Hospital Details
            </h1>
            <div className="flex mt-4 ">
              <img src={hospital} alt="hospital" className="h-6 w-6" />
              <h1 className="ml-4"> {doctor.org}</h1>
            </div>

            <div className="flex mt-3">
              <img src={hospital_contact} alt="contact" className="w-5 h-5 " />
