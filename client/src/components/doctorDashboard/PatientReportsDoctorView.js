  ...
  return (
    <div className="col-span-10">
      {props.healthID.length === 12 ? (
        <div className="bg-lime-200 mt-0">
          <div className="h-screen">
            <div className="font-lato  mainf">
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow ml-auto h-14 w-1/5 mr-5 mt-8">
                  <img
                    src={doctor_profile}
                  ...
                  <div className="grid grid-rows-2 ml-4 gap-2  mb-4">
                    <div className="font-bold font-lato text-base flex my-2">
                      <h1>Dr.</h1>
                      <h1 className="ml-2">
        ...
        <div className="text-xl flex justify-center items-center font-bold font-lato my-80 py-4 flex-col ">
          <div>Search Patient ID to see Reports</div>
          <Link
            to="/doctor/dashboard"
            className="text-md py-1 px-4 bg-cyan-300  font-lato rounded mt-3 hover:bg-gray-100"
          >
            Return to DashBoard
          </Link>
        </div>
